  ...
  <div className="flex h-screen w-screen font-inter">
    ...
    <div className="flex-1 bg-[#0dc0e0] flex items-center justify-center">
      <div className="text-white text-center px-8">
        <h1 className="text-3xl font-bold mb-4">Sistema gestor de pacientes para odontólogos</h1>
        <p className="text-lg mb-2">Organiza citas, historial y tratamientos</p>
  ...
  {/* Lado Derecho - Blanco */}
    ...
    <div className="text-center">
      <div className="bg-gray-100 rounded-xl p-6 w-95 mx-auto border border-gray-200 shadow-sm">
        <h1 className="text-2xl font-bold text-gray-800 mb-5">Iniciar sesión</h1>
        ...
        <button className="cursor-pointer w-full mt-8 bg-[#0dc0e0] text-white font-bold py-3 rounded-lg  transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105" 
